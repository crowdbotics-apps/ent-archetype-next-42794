...
## Project Structure
    ...
    ├── ent_workflow_canvas_42794  # Django project configurations
...
1. Clone this repo and `cd ent_workflow_canvas_42794`
...
2. Clone this repo and `cd ent_workflow_canvas_42794`
